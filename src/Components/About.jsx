...
const aboutElements = [
  {
    ...
    description:
      "Création d’interfaces web performantes, responsives et centrées sur l’expérience utilisateur.",
  ...
  },
  {
    ...
    description:
      "Développement de solutions serveur fiables, sécurisées et adaptées aux besoins des applications modernes.",
  ...
  },
  {
    ...
    description:
      "Mise en place d’architectures solides et de bonnes pratiques de développement pour des applications performantes et durables.",
