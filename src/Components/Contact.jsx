...
function Contact() {
  ...
  const validateForm = () => {
    ...
    if (!formData.message.trim()) {
      ...
      newErrors.message = t("contact.errors.messageMin", { count: 10 });
    }
      ...
      <div className="max-w-7xl mx-auto px-5">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            {t("contact.title.before")} <span className="text-accent">{t("contact.title.accent")}</span>
          </h1>
            ...
            <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="card-body p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="card-title text-lg mb-1">{t("contact.info.emailTitle")}</h3>
                    <a
            ...
            <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="card-body p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="card-title text-lg mb-1">{t("contact.info.locationTitle")}</h3>
            ...
            <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="card-body p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="card-title text-lg mb-3">{t("contact.info.socialTitle")}</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="form-control">
                    <label htmlFor="name" className="label">
                      <span className="label-text font-semibold">{t("contact.form.nameLabel")}</span>
                    </label>
                    <input
                      type="text"
                      id="name"
                  ...
                  <div className="form-control">
                    <label htmlFor="email" className="label">
                      <span className="label-text font-semibold">{t("contact.form.emailLabel")}</span>
                    </label>
                    <input
                      type="email"
                      id="email"
                ...
                <div className="form-control">
                  <label htmlFor="subject" className="label">
                    <span className="label-text font-semibold">{t("contact.form.subjectLabel")}</span>
                  </label>
                  <input
                    type="text"
                    id="subject"
                ...
                <div className="form-control">
                  <label htmlFor="message" className="label">
                    <span className="label-text font-semibold">{t("contact.form.messageLabel")}</span>
                  </label>
                  <textarea
                    id="message"
                    name="message"
                    ...
                    onChange={handleChange}
                    rows="6"
                    className={`textarea textarea-bordered resize-y min-h-[120px] md:w-150 ${
                ...
                {formStatus.error && (
                  <div className="alert alert-error">
                    ...
                    <span>{t("contact.status.error")}</span>
                  </div>
                )}
              </form>
            </div>
